...
export const mockDiseases: Disease[] = [
  {
    ...
    icdCode: 'A90',
    pathogenFamily:          'Flaviviridae',
    genomeType:              'Positive-sense ssRNA',
    incubationMinDays:       4,
    incubationMaxDays:       10,
    firstIdentifiedYear:     1779,
    firstIdentifiedLocation: 'Asia',
  },
  {
    id: 2,
    name: 'Malaria',
    ...
    icdCode: 'B50-B54',
    pathogenFamily:          'Plasmodiidae',
    genomeType:              'DNA (nuclear and mitochondrial)',
    incubationMinDays:       7,
    incubationMaxDays:       30,
    firstIdentifiedYear:     1880,
    firstIdentifiedLocation: 'Africa/Asia',
  },
  {
    id: 3,
    name: 'Zika',
    ...
    genomeType:              'Positive-sense ssRNA',
    incubationMinDays:       3,
    incubationMaxDays:       14,
    firstIdentifiedYear:     1947,
    firstIdentifiedLocation: 'Uganda (Zika Forest)',
  },
  {
    id: 4,
    name: 'West Nile',
    ...
    incubationMinDays:       2,
    incubationMaxDays:       14,
    firstIdentifiedYear:     1937,
    firstIdentifiedLocation: 'Uganda (West Nile district)',
  },
  {
    id: 5,
    name: 'Chikungunya',
    ...
    icdCode: 'A92.0',
    pathogenFamily:          'Togaviridae',
    genomeType:              'Positive-sense ssRNA',
    incubationMinDays:       1,
    incubationMaxDays:       12,
    firstIdentifiedYear:     1952,
    firstIdentifiedLocation: 'Tanzania (Makonde Plateau)',
  },
]
